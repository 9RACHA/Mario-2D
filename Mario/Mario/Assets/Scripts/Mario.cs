...
public class Mario : MonoBehaviour {
    ...
    //Booleano para controlar la imnunidad (y el parpadeo) de Mario
    //Lo hago publico para poder jugar con el en directo en el inspector
    //lo suyo sería que fuese privado
    public bool inmune;

    //Semi frecuencia del parpadeo de Mario
    float blinkFrecuency = 10f;

    //Limites de tiempo para Mario sin matar tortugas
    private float t1 = 20;
    private float t2 = 5; 
    private float t3 = 1;
    ...
    //en los siguientes instantes despues de iniciarse un salto
    ...
    public void StartInmunity() {
        ...
        //TODO Cambiar a Mario á capa PlayerInmune (cando esta exista)
    ...
    private void EndInmunity() {
        inmune = false;
        //Devolvemos a Mario á capa Player
    ...
    private IEnumerator Blink() {
        ...
        while(inmune) {
            maskColor.a = Mathf.PingPong(Time.time * blinkFrecuency, 1);
    ...
    private void MarioDie() {
        ...
        //Anotamos la vida perdida en el GameManager, que espaneará otro Mario si quedan vidas
    ...
    //Debería chamarse OnGettingShockedCompleted
